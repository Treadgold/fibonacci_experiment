...
🚀 Compute Fibonacci numbers at **~1+ billion per second** using optimized C++ with Python bindings!

## Features

- ⚡ **Blazingly fast**: Uses Binet's formula with O(1) complexity
- 🔄 **Parallel processing**: Leverages all CPU cores with OpenMP
- 🐍 **Python-friendly**: Simple, intuitive API
- 📊 **NumPy integration**: Returns NumPy arrays for data science
- 🎯 **Optimized C++**: Compiled with -O3, -march=native, and more
